...
var imgdata = new Array(//这是个存图片的数组，为了一会加载用
	...
	{name:"holeback",path:"./IMG/黑洞背景.png"},//黑洞背景
	...
	{name:"nextLevel",path:"./IMG/nextLevel.png"},
	{name:"gq1",path:"./IMG/1.jpg"},
	{name:"gq2",path:"./IMG/2.jpg"},
	{name:"gq3",path:"./IMG/3.jpg"},
	{name:"tips",path:"./IMG/TAH.png"},
	{name:"wanfa",path:"./IMG/wanfa.png"},
	{name:"mk",path:"./IMG/mukuai.png"},
	{name:"mk1",path:"./IMG/mukuai1.png"},
	{name:"SelectBg", path: "./IMG/SelectBg.jpg"},//选择界面背景
	{name:"title", path:"./IMG/title.png"},//头像框
	{name:"life", path:"./IMG/life.png"},//血条
	{name:"icon", path:"./IMG/icon.png"},
	{name:"addHealth", path:"./IMG/addHealth.png"},
	);//下一关
